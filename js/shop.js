...
let PRODUCTS = [
  // Oils & Fats
  { id: 'p001', name: 'Premium Red Palm Oil', category: 'oils', price: 8.99, oldPrice: 11.99, badge: 'hot', tag: 'Oils & Fats', desc: 'Pure unrefined red palm oil, rich in nutrients and perfect for traditional Nigerian cooking.', img: 'assets/images/palmoil.jpg', weight: '1L', inStock: true },
  { id: 'p002', name: 'Palm Oil 5L Canister', category: 'oils', price: 32.99, oldPrice: null, badge: 'new', tag: 'Oils & Fats', desc: 'Value-size pure red palm oil for the whole family. Ideal for large portions of egusi or banga soup.', img: 'assets/images/kegoil.jpg', weight: '5L', inStock: true },
  { id: 'p003', name: 'Palm Kernel Oil', category: 'oils', price: 9.49, oldPrice: null, badge: null, tag: 'Oils & Fats', desc: 'Cold-pressed palm kernel oil, great for soups, cooking and traditional remedies.', img: 'assets/images/palmoil.jpg', weight: '500ml', inStock: true },

  // Dried Fish & Seafood
  { id: 'p004', name: 'Dried Catfish (Eja Aro)', category: 'fish', price: 12.99, oldPrice: 15.99, badge: 'sale', tag: 'Dried Fish & Seafood', desc: 'Smoked and sun-dried catfish, essential for pepper soup, egusi, and many Nigerian stews.', img: 'assets/images/fishdried.jpg', weight: '500g', inStock: true },
  { id: 'p005', name: 'Whole Dried Catfish Large', category: 'fish', price: 18.99, oldPrice: null, badge: 'hot', tag: 'Dried Fish & Seafood', desc: 'Premium large whole dried catfish. Deeply smoky flavour perfect for banga soup and ofe onugbu.', img: 'assets/images/fishdried.jpg', weight: '1kg', inStock: true },
  { id: 'p006', name: 'Ground Crayfish (Ijeba)', category: 'fish', price: 5.99, oldPrice: 7.49, badge: 'sale', tag: 'Dried Fish & Seafood', desc: 'Finely ground dried crayfish — adds authentic depth to any Nigerian soup or stew.', img: 'assets/images/fishdried.jpg', weight: '200g', inStock: true },
